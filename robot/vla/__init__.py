...
contains only the lazy client; the server lives in
``external_model_server/openpi_batch_server.py``. Client and server are coupled
only through the websocket protocol, never through Python objects.
"""
