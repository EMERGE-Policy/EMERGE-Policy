...
class SkillsLoader:
    ...
    def _parse_emerge_metadata(self, raw: str) -> dict:
        """Parse skill metadata JSON from frontmatter (supports Emerge and openclaw keys)."""
        try:
            data = json.loads(raw)
            return data.get("Emerge", data.get("openclaw", {})) if isinstance(data, dict) else {}
    ...
    def _get_skill_meta(self, name: str) -> dict:
        """Get Emerge metadata for a skill (cached in frontmatter)."""
        meta = self.get_skill_metadata(name) or {}
        return self._parse_emerge_metadata(meta.get("metadata", ""))
    ...
    def get_always_skills(self) -> list[str]:
        ...
        for s in self.list_skills(filter_unavailable=True):
            ...
            skill_meta = self._parse_emerge_metadata(meta.get("metadata", ""))
